    ...
    <body class="min-h-screen flex flex-col">
                ...
                <div class="max-w-[1240px] mx-auto px-4 flex items-center justify-between gap-4">
                    ...
                    <div class="flex items-center gap-3 xl:gap-5 text-xs font-semibold">
                        ...
                        <a href="{{ route('cart.index') }}" class="flex flex-col items-center gap-0.5 hover:text-yellow-200 transition relative">
                            ...
                            <span>Gio hang</span>
                            <span class="absolute -top-1.5 -right-2 bg-yellow-300 text-gray-900 font-bold text-[9px] min-w-4 h-4 px-1 rounded-full flex items-center justify-center border border-white">{{ $cartCount }}</span>
                        </a>
                    </div>
                </div>
            </div>
        ...
        <main class="flex-1 max-w-[1240px] w-full mx-auto px-4 py-6">
            @if (session('cart_success'))
                <div class="mb-4 rounded-[15px] border border-emerald-200 bg-emerald-50 px-4 py-3 text-sm text-emerald-700">
        ...
        <footer class="w-full bg-white border-t border-gray-200 mt-16 pt-12 pb-8">
            <div class="max-w-[1240px] mx-auto px-4">
                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
                    <div class="flex flex-col gap-4">
                        ...
                        <ul class="flex flex-col gap-2.5 text-xs text-gray-600">
                            <li><a href="#" class="hover:text-orange-600 transition">Gioi thieu</a></li>
                            <li><a href="#" class="hover:text-orange-600 transition">He thong cua hang</a></li>
                            <li><a href="#" class="hover:text-orange-600 transition">Lien he</a></li>
                            <li><a href="#" class="hover:text-orange-600 transition">Tuyen dung</a></li>
                        </ul>
                    </div>

                    <div class="flex flex-col gap-4">
                        <h3 class="text-gray-900 font-bold text-sm uppercase tracking-wider">San pham</h3>
                        <ul class="flex flex-col gap-2.5 text-xs text-gray-600">
                            <li><a href="#" class="hover:text-orange-600 transition">Dien thoai</a></li>
                            <li><a href="#" class="hover:text-orange-600 transition">Macbook</a></li>
                            <li><a href="#" class="hover:text-orange-600 transition">May tinh bang</a></li>
                            <li><a href="#" class="hover:text-orange-600 transition">Dong ho thong minh</a></li>
                            <li><a href="#" class="hover:text-orange-600 transition">Phu kien</a></li>
                        </ul>
                    </div>

                    <div class="flex flex-col gap-4">
                        <h3 class="text-gray-900 font-bold text-sm uppercase tracking-wider">Chinh sach</h3>
                        <ul class="flex flex-col gap-2.5 text-xs text-gray-600">
                            <li><a href="#" class="hover:text-orange-600 transition">Mua hang</a></li>
                            <li><a href="#" class="hover:text-orange-600 transition">Bao hanh</a></li>
                            <li><a href="#" class="hover:text-orange-600 transition">Van chuyen</a></li>
                            <li><a href="#" class="hover:text-orange-600 transition">Bao mat</a></li>
                        </ul>
                    </div>

                    <div class="flex flex-col gap-4">
                        <h3 class="text-gray-900 font-bold text-sm uppercase tracking-wider">Ho tro</h3>
                        <ul class="flex flex-col gap-2.5 text-xs text-gray-600">
                            <li><a href="#" class="hover:text-orange-600 transition">Huong dan mua online</a></li>
                            <li><a href="#" class="hover:text-orange-600 transition">Phuong thuc thanh toan</a></li>
                            <li><a href="#" class="hover:text-orange-600 transition">Cau hoi thuong gap</a></li>
                        </ul>
                    </div>

                    <div class="flex flex-col gap-4 col-span-2 md:col-span-1">
                        <h3 class="text-gray-900 font-bold text-sm uppercase tracking-wider">Tong dai ho tro</h3>
                        <ul class="flex flex-col gap-2 text-xs text-gray-600">
                            <li>Tu van mua hang: <a href="tel:02466819779" class="font-bold text-gray-900 hover:text-orange-600 transition">0246 6819 779</a></li>
                            <li>Bao hanh: <a href="tel:02466819779" class="font-bold text-gray-900 hover:text-orange-600 transition">0246 6819 779</a></li>
                            <li>Ky thuat: <a href="tel:02466819779" class="font-bold text-gray-900 hover:text-orange-600 transition">0246 6819 779</a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="mt-12 pt-8 border-t border-gray-200 text-center md:text-left flex flex-col md:flex-row justify-between items-center gap-4 text-[11px] text-gray-500">
                    <p>© 2026 StoreDP. Tat ca cac quyen duoc bao luu.</p>
                    <p>388 Cau Giay - P. Dich Vong - Q. Cau Giay - TP. Ha Noi</p>
                </div>
            </div>
        </footer>
    </body>
