<x-layouts.admin title="Thêm hãng sản xuất">
    <!-- Page Header -->
    <div class="mb-6">
        ...
        <h1 class="text-2xl font-bold text-slate-800">Thêm hãng sản xuất</h1>
        <p class="text-sm text-slate-500 mt-1">Tạo một hãng sản xuất / thương hiệu mới trên hệ thống.</p>
    </div>

    <!-- Form Container -->
    <div class="bg-white rounded-xl shadow-sm border border-slate-200/60 overflow-hidden max-w-3xl">
        <form method="POST" action="{{ route('admin.product-brands.store') }}" class="p-6 sm:p-8 space-y-6">
            @csrf
