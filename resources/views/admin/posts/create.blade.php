<x-layouts.admin title="Viết Bài mới">
    <div class="mb-6 flex items-center gap-3">
        ...
        <div>
            <h1 class="text-2xl font-bold text-slate-800">Viết Bài mới</h1>
        </div>
    </div>
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
                ...
                <textarea name="excerpt" id="excerpt" rows="3"
                    class="block w-full rounded-lg border-slate-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm px-4 py-2 border transition-colors @error('excerpt') border-red-500 @enderror">{{ old('excerpt') }}</textarea>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
                ...
                <div>
                    ...
                    <input type="text" name="slug" id="slug" value="{{ old('slug') }}"
                        class="block w-full rounded-lg border-slate-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm px-4 py-2 border transition-colors bg-slate-50 @error('slug') border-red-500 @enderror" placeholder="Để trống để tự động tạo từ tiêu đề">
